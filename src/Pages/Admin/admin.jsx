                ...
                <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                    ...
                    >
                        <div className="max-w-xl lg:max-w-3xl">
                            ...
                            <h1 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl dark:text-white">
                                Welcome to Squid 🦑
                            </h1>

                            <p className="mt-4 leading-relaxed text-white-500 dark:text-white-400">
                            ...
                            <form action="#" className="mt-8 grid grid-cols-6 gap-6">
                                ...
                                <div className="col-span-6">
                                    <label htmlFor="Email" className="block text-sm font-medium text-white-700 dark:text-white-200">
                                        Email
                                    </label>
                                ...
                                <div className="col-span-6 sm:col-span-3">
                                    <label
                                        htmlFor="Password"
                                        className="block text-sm font-medium text-white-700 dark:text-white-200"
                                    >
                                        Password
                                    </label>
